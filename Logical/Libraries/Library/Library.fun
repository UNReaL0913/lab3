...
{REDUND_ERROR} {REDUND_UNREPLICABLE} FUNCTION_BLOCK FB_Direction (*TODO: Add your comment here*) (*$GROUP=User,$CAT=User,$GROUPICON=User.png,$CATICON=User.png*)
	VAR_INPUT
		go : {REDUND_UNREPLICABLE} BOOL;
	END_VAR
END_FUNCTION_BLOCK
